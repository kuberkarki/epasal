...
class _AccountDetailPageState extends State<AccountDetailPage>
  ...
  int _page;
  List<Order> _orders;
  wp.User _wcCustomerInfoResponse;
  bool _isLoading;
  ...
  _fetchWpUserData() async {
    var wcCustomerInfoResponse=await wordPress.fetchUser(id: int.parse(await readAuthToken()));
      print(wcCustomerInfoResponse);
                            ...
                            Container(
                              ...
                              child: CircleAvatar(
                                backgroundImage: NetworkImage(
                                  _wcCustomerInfoResponse.avatarUrls.s24,
                                ),
                              ),
                              height: 90,
                              width: 90,
                                      ...
                                      children: <Widget>[
                                        Text(
                                          (_wcCustomerInfoResponse == null
                                              ? ""
                                              : [
                                                  _wcCustomerInfoResponse.name,
                                                  // _wcCustomerInfoResponse.lastName
                                                ]
                                                  .where((t) =>
                                                      (t != null || t != ""))
                                                  .toList()
  ...
  _fetchOrders() async {
    ...
    _orders = await appPasalConnector((api) {
